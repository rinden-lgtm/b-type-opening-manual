    ...
    nav: [
      ...
      { text: 'チェックリスト', link: '/12-checklist' },
      {
        ...
        items: [
          ...
          { text: 'サビ管雇用契約書（雛形）', link: '/templates/employment-contract-sabikan' },
          { text: '支援スタッフ雇用契約書（雛形）', link: '/templates/employment-contract-staff' },
          { text: '利用者サービス利用契約書（雛形）', link: '/templates/user-service-contract' },
          { text: '重要事項説明書（雛形）', link: '/templates/important-matters-notice' },
          { text: '利用規約・運営規程（雛形）', link: '/templates/facility-rules' },
          { text: '個人情報保護方針（雛形）', link: '/templates/privacy-policy' },
          { text: '工賃規程（雛形）', link: '/templates/wage-regulations' },
          { text: '個別支援計画（雛形）', link: '/templates/individual-support-plan' },
        ],
      },
    ],
